...
<div class="container mui-pt45">
    <!-- <div class="user-free">
        <div class="user-free-box">
             <img src="<?php //echo img('PmY88022900gr');?>" alt="">
             <img class="share-img" src="<?php //echo mUserQrcode();?>" alt="">
        </div>
    ...
    <div id="imgBox" align="center" style="margin-bottom: 100px;">
        ...
        if(n<len){
            ...
            img.onload=function(){
                ...
                if(n == 1){
                    ...
                    ctx.drawImage(img,200,210, 60,60);
                }else{
