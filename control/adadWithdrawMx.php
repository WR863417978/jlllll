...
if(empty($get['id'])){
    ...
    if ($withdraw['id'] != $get['id']) {
        ...
        header("location:{$root}control/adadWithdraw.php");
        exit(0);
    }
...
$onion = array(
    "提现管理" => root."control/adadWithdraw.php",
    $title => $ThisUrl
);
        ...
        <div class='adStatus kuang'>
            ...
            <form name="textForm">
                <table class="tableRight">
                    ...
                    <tr>
                        <td>申请人姓名：</td>
                        <td><?php echo $kname['name']?></td>
                    </tr>
                    <tr>
                        <td>提现金额：</td>
                        <td><?php echo $withdraw['changeCode']?></td>
                    </tr>
                    <tr>
                        <td>操作人：</td>
                        <td><?php echo $aname['adname']?></td>
                    </tr>
                    <tr>
